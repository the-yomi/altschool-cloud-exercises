...
sudo wget --quiet -0 - https://www.postgresql.org/media/keys/ACCC4CF8.asc | sudo apt-key add -
...
sudo -i -u postgres psql -c "GRANT ALL PRIVILEGES ON DATABASE laravelto laravel;"
cd /
